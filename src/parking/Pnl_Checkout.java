...
public class Pnl_Checkout extends javax.swing.JPanel {
	...
	model.setRowCount(0);
	try{
	    String sql = "SELECT * FROM `bookdata` WHERE `datein` = ? AND `check` = '1'";
	    Connection con = MyConnection.getConnection();
	    PreparedStatement pst = con.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Check Out & Cancel Booking");
        ...
        bn_checkout.setFont(new java.awt.Font("Dubai Medium", 1, 18)); // NOI18N
        bn_checkout.setText("CheckOut");
        ...
        bn_showall.setBackground(new java.awt.Color(153, 153, 255));
        bn_showall.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        bn_showall.setText("Show All (Enable cancel)");
        bn_showall.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bn_showallMouseClicked(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(bn_showall))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(95, 95, 95)
                        .addComponent(bn_re, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(145, 145, 145)
                        .addComponent(bn_checkout, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))
	...
	if(bn_showall.isSelected()){
	    CheckOutConfirm checkcon = new CheckOutConfirm(lot, datein, timein, timeout, name, license, phone, other, "Cancel");
	    checkcon.setVisible(true);
	}else{
	    CheckOutConfirm checkcon = new CheckOutConfirm(lot, datein, timein, timeout, name, license, phone, other, "Check Out");
	    checkcon.setVisible(true);
	}
	
    }//GEN-LAST:event_bn_checkoutActionPerformed

    private void bn_showallMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bn_showallMouseClicked
        if(bn_showall.isSelected()){
	    updateAllTable();
	    bn_checkout.setText("Cancel Booking");
    ...
    }//GEN-LAST:event_bn_showallMouseClicked
    ...
    private javax.swing.JCheckBox bn_showall;
